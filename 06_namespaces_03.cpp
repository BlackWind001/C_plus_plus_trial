...
Namespace_class::Namespace_class(int i = 0, int j = 0) : x(i), y(j)
{}

int Namespace_class::Namespace_func_add(){
	return x + y;
}

int Namespace_class::get_x(){
	return x;
}

int Namespace_class::get_y(){
	return y;
}

Namespace_class New_namespace::add(Namespace_class i, Namespace_class j){
...
int main(){
	Namespace_class obj1(5,5);
	Namespace_class obj2(11,11);
